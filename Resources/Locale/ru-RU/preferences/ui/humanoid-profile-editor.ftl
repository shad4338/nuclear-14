...
humanoid-profile-editor-traits-show-unusable-button-tooltip =
    При включении этой опции будут показаны черты, которые ваш текущий персонаж не может использовать, выделенные красным цветом.
...
humanoid-profile-editor-traits-remove-unusable-button-tooltip =
    Если вы нажмете эту кнопку, все черты, которые ваша текущая настройка персонажа не может использовать, будут удалены.
...
humanoid-profile-editor-loadouts-remove-unusable-button = Удалить {$count ->
    [1] {$count} недоступное
    *[other] {$count} недоступное
}
humanoid-profile-editor-loadouts-remove-unusable-button-tooltip =
    Если вы нажмете на эту кнопку, все предметы, которые не могут быть использованы в текущей настройке персонажа, будут удалены.
